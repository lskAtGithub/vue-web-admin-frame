...
function handleTogleSide() {
  systemInstans.changeCollapse()
}
</script>

<template>
  <div class="header-topbar-box">
    <div class="left-side" :class="{ 'collapse': systemInstans.isCollapse }">
      <svg t="1680145575634" class="icon admin-icon" viewBox="0 0 1024 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="12947">
        <path
      ...
      <!-- <div class="admin-title" v-show="!systemInstans.isCollapse">{{ title }}</div> -->
      <div class="admin-title" v-show="!systemInstans.isCollapse"></div>
    </div>
